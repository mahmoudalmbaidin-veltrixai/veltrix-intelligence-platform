...
<template>
  <div class="err">
    ...
    <p class="err__note">
      Frontend permission checks are a UX convenience only — the backend remains the security boundary.
    </p>
    <div class="err__actions">
      <VipButton variant="primary" icon="home" @click="router.push('/home')">Back to Home</VipButton>
    </div>
  </div>
</template>
