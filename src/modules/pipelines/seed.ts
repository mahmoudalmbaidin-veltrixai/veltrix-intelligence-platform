    ...
    nodes: [
      {
        ...
        x: 80,
        y: 120,
        config: { connection: 'cn_mssql_erp', mode: 'table', table: 'dbo.orders' },
      },
      {
        id: 'n2',
        kind: 'source-database',
        ...
        x: 80,
        y: 300,
        config: { connection: 'cn_mysql_billing', mode: 'table', table: 'invoices' },
      },
      { id: 'n3', kind: 'filter', title: 'Active only', x: 360, y: 120, config: { expression: "status = 'active'" } },
      {
        ...
        x: 620,
        y: 200,
        config: { type: 'left', leftKey: 'order_id', rightKey: 'order_id' },
      },
      {
        id: 'n5',
        kind: 'aggregate',
        title: 'Rollup by region',
        x: 880,
        y: 200,
        config: { groupBy: 'region', aggregations: { revenue: 'sum' } },
      },
      {
        id: 'n6',
        kind: 'output-dataset',
        ...
        x: 1140,
        y: 200,
        config: { datasetName: 'fct_orders', writeMode: 'overwrite', certify: true },
      },
    ],
    edges: [
    ...
    nodes: [
      {
        ...
        x: 80,
        y: 160,
        config: { url: 'https://api.crm/v1/accounts', method: 'GET', jsonPath: '$.records' },
      },
      {
        id: 'm2',
        kind: 'select-columns',
        ...
        x: 360,
        y: 160,
        config: { columns: ['id', 'name', 'segment'] },
      },
      {
        id: 'm3',
        kind: 'output-dataset',
        ...
        x: 640,
        y: 160,
        config: { datasetName: 'dim_customers', writeMode: 'merge' },
      },
    ],
    edges: [
    ...
    nodes: [
      {
        ...
        x: 120,
        y: 180,
        config: { connection: 'cn_s3_lake', path: 's3://lake/events/*.parquet', format: 'parquet' },
      },
    ],
    edges: [],
  },
