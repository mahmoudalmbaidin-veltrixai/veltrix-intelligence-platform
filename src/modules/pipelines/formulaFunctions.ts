...
export const FORMULA_FUNCTIONS: FormulaFn[] = [
  ...
  },
  {
    ...
    description: 'Raises base to a power.',
    example: 'POWER([x], 2)',
  },
  {
    name: 'MOD',
  ...
  { name: 'LEN', category: 'Text', signature: 'LEN(text)', description: 'Length of the text.', example: 'LEN([name])' },
  {
    ...
    description: 'Replaces occurrences of old with new.',
  ...
  // Logical
  {
    ...
    example: 'IF([revenue] > 0, "active", "none")',
  },
  {
    name: 'AND',
    category: 'Logical',
    signature: 'AND(cond, …)',
    description: 'True when all conditions are true.',
    example: 'AND([a] > 0, [b] > 0)',
  },
  {
    name: 'OR',
    category: 'Logical',
    signature: 'OR(cond, …)',
    description: 'True when any condition is true.',
    example: 'OR([vip], [priority])',
  },
  {
    name: 'NOT',
    category: 'Logical',
  ...
  },
  {
    ...
    description: 'True when the value is null.',
  ...
  { name: 'TODAY', category: 'Date', signature: 'TODAY()', description: 'Current date.', example: 'TODAY()' },
  {
    ...
    example: 'DATEDIFF("day", [created], TODAY())',
  },
  {
    name: 'DATEADD',
    category: 'Date',
    signature: 'DATEADD(unit, n, date)',
    description: 'Adds an interval to a date.',
    example: 'DATEADD("month", 1, [start])',
  },
  {
    name: 'YEAR',
    category: 'Date',
  ...
  // Conversion
  {
    name: 'TONUMBER',
    category: 'Conversion',
    signature: 'TONUMBER(text)',
    description: 'Parses text to a number.',
    example: 'TONUMBER([amount_str])',
  },
  {
    name: 'TOTEXT',
    category: 'Conversion',
  ...
  },
  {
    ...
    description: 'Parses text to a date.',
    example: 'TODATE([date_str])',
  },
]
...
export function validateFormula(expr: string): FormulaValidation {
  ...
  if (unknown.length)
    errors.push(`Unknown function${unknown.length > 1 ? 's' : ''}: ${[...new Set(unknown)].join(', ')}.`)
