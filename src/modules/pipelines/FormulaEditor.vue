    ...
    <div class="fx__editor">
      ...
      <div class="fx__status" :class="validation.valid ? 'is-ok' : 'is-err'">
        ...
        <span v-if="validation.valid"
          >Valid · {{ validation.usedFunctions.length }} function(s),
          {{ validation.usedColumns.length }} column(s)</span
        >
