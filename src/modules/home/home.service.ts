    ...
    return {
      health: [
        ...
        },
        {
          ...
          tone: 'warning',
          icon: 'workflow',
          spark: [98, 97, 96, 95, 92, 94, 94],
        },
        {
          label: 'Datasets fresh',
          value: '128',
          delta: 6,
          tone: 'info',
          icon: 'database',
          spark: [110, 114, 118, 120, 124, 126, 128],
        },
        {
      ...
      activity: [
        {
          id: 'a1',
          actor: 'Nightly Scheduler',
          action: 'ran',
          target: 'Customer 360 Build',
          when: isoAgo(12),
          icon: 'run',
        },
        {
          ...
          actor: 'A. Rahman',
          action: 'published',
          target: 'Revenue Operations dashboard',
          when: isoAgo(46),
          icon: 'chart',
        },
        {
        ...
        },
        {
          id: 'a5',
          actor: 'Automation',
          action: 'sent alert for',
          target: 'Revenue Nightly ETL failure',
          when: isoAgo(240),
          icon: 'bell',
        },
      ],
