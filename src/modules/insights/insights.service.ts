...
const SEED: Insight[] = [
  {
    ...
    sentiment: 'positive',
    finding:
      'Revenue grew steadily over the last 6 months, up 18.4% versus the prior period, driven mainly by the Enterprise segment in EMEA.',
    modelId: 'sm_sales',
    metricLabel: 'Revenue',
    ...
    confidence: 0.92,
    freshness: isoAgo(35),
    series: series(6, true),
    breakdownDimension: 'segment',
    recommendedAction: 'Increase EMEA Enterprise capacity to sustain momentum.',
    relatedVisual: 'line',
    simulated: true,
    pinned: false,
    saved: false,
  },
  {
    id: 'in_2',
    kind: 'anomaly',
    title: 'Unusual drop in APAC orders',
    sentiment: 'negative',
    finding:
      'APAC orders fell 27% in the last week — 3.1σ below the expected range. This coincides with the Self-Serve channel outage on the 4th.',
    modelId: 'sm_sales',
    metricLabel: 'Orders',
    metricValue: 1_240,
    metricFormat: 'compact',
    comparisonLabel: 'vs 8-week baseline',
    changePct: -27,
    confidence: 0.81,
    freshness: isoAgo(120),
    series: series(8, false),
    breakdownDimension: 'channel',
    recommendedAction: 'Confirm Self-Serve checkout recovery in APAC.',
    relatedVisual: 'column',
    simulated: true,
    pinned: false,
    saved: false,
  },
  {
    id: 'in_3',
    kind: 'target-variance',
    title: 'Margin below target',
    sentiment: 'negative',
    finding:
      'Margin is 24.1% against a 27% target — a 2.9pt shortfall. Hardware discounting in Americas is the largest contributor.',
    modelId: 'sm_sales',
    metricLabel: 'Margin %',
    metricValue: 0.241,
    metricFormat: 'percent',
    comparisonLabel: 'vs 27% target',
    changePct: -10.7,
    confidence: 0.88,
    freshness: isoAgo(60),
    breakdownDimension: 'category',
    recommendedAction: 'Review Americas Hardware discount policy.',
    relatedVisual: 'gauge',
    simulated: true,
    pinned: false,
    saved: false,
  },
  {
    id: 'in_4',
    kind: 'top-increase',
    title: 'Software is the top growth category',
    sentiment: 'positive',
    finding:
      'Software contributed 46% of revenue growth this quarter, adding $612K — more than the next two categories combined.',
    modelId: 'sm_sales',
    ...
    breakdownDimension: 'category',
    recommendedAction: 'Prioritise Software pipeline in Q4 planning.',
    relatedVisual: 'bar',
    simulated: true,
    pinned: false,
    saved: false,
  },
  {
    ...
    title: 'Partner channel outpacing Direct',
    sentiment: 'neutral',
    finding:
      'Partner revenue grew 22% while Direct grew 6% period-over-period. Partner now accounts for 38% of total revenue, up from 33%.',
    modelId: 'sm_sales',
    metricLabel: 'Partner revenue',
    metricValue: 1_830_000,
    metricFormat: 'currency',
    ...
    series: series(6, true),
    breakdownDimension: 'channel',
    recommendedAction: 'Assess partner enablement investment.',
    relatedVisual: 'area',
    simulated: true,
    pinned: false,
    saved: false,
  },
  {
    id: 'in_6',
    kind: 'contribution',
    title: 'EMEA drives half of profit',
    sentiment: 'positive',
    finding:
      'EMEA contributes 51% of total profit despite being 43% of revenue, reflecting a higher-margin product mix.',
    modelId: 'sm_sales',
    metricLabel: 'Profit contribution',
    metricValue: 0.51,
    metricFormat: 'percent',
    comparisonLabel: 'share of total profit',
    changePct: 8,
    confidence: 0.87,
    freshness: isoAgo(150),
    breakdownDimension: 'region',
    recommendedAction: 'Replicate EMEA product mix in other regions.',
    relatedVisual: 'donut',
    simulated: true,
    pinned: false,
    saved: false,
...
const mockInsightsService: InsightsService = {
  ...
  async explain(question: string): Promise<Insight> {
    ...
    return {
      ...
      modelId: 'sm_sales',
      metricLabel: 'Revenue',
      metricValue: Math.round(3_000_000 + rng() * 2_000_000),
      metricFormat: 'currency',
      comparisonLabel: 'vs previous period',
      changePct: change,
      confidence: 0.6 + rng() * 0.3,
      freshness: new Date().toISOString(),
      series: series(6, change >= 0),
      breakdownDimension: 'segment',
      recommendedAction: 'Explore the breakdown to validate the driver.',
      relatedVisual: 'line',
      simulated: true,
      pinned: false,
      saved: false,
