...
const REPORTS: Report[] = [
  {
    ...
    description: 'Quarterly performance pack for the board of directors.',
    status: 'in-review',
    owner: 'A. Rahman',
    updatedAt: isoAgo(35),
    version: 'v4.2',
    reviewers: ['Board Office', 'Finance', 'Legal'],
  },
  {
    id: 'rp_revops',
    name: 'Revenue Operations Review',
    description: 'Weekly pipeline, bookings and forecast attainment.',
    status: 'published',
    owner: 'Revenue Ops',
  ...
  },
  {
    ...
    description: 'P&L, balance sheet and cash flow with commentary.',
    status: 'approved',
    owner: 'Finance',
    updatedAt: isoAgo(60 * 20),
    version: 'v8.1',
  ...
  },
  {
    ...
    description: 'Channel spend, CAC and campaign ROI breakdown.',
    status: 'draft',
    owner: 'Growth',
    updatedAt: isoAgo(60 * 5),
    version: 'v0.3',
    reviewers: [],
  },
  {
    id: 'rp_ops',
    name: 'Platform Reliability Report',
    description: 'SLA attainment, incidents and error budgets.',
    status: 'published',
    owner: 'Platform',
    updatedAt: isoAgo(60 * 40),
    version: 'v6.4',
    reviewers: ['VP Eng'],
  },
  {
    ...
    description: 'One-page executive summary across the business.',
    status: 'rejected',
    owner: 'Chief of Staff',
    updatedAt: isoAgo(60 * 8),
    version: 'v2.7',
    reviewers: ['CEO', 'CFO'],
  },
  {
    ...
    description: 'Inventory turns, fill rate and logistics cost.',
    status: 'in-review',
    owner: 'Supply Chain',
    updatedAt: isoAgo(60 * 12),
    version: 'v3.0',
    reviewers: ['COO'],
  },
]
...
const TEMPLATES: ReportTemplate[] = [
  {
    id: 'tpl_board',
    name: 'Board Pack',
    description: 'Cover, executive summary, financials and appendix.',
    sections: 8,
  },
  {
    id: 'tpl_kpi',
    name: 'KPI Scorecard',
    description: 'Single-page grid of headline metrics with trend.',
    sections: 3,
  },
  {
    id: 'tpl_financial',
    name: 'Financial Statements',
    description: 'P&L, balance sheet and cash flow layouts.',
    sections: 6,
  },
  {
    id: 'tpl_ops',
    name: 'Operations Review',
    description: 'Reliability, incidents and error-budget sections.',
    sections: 5,
  },
  { id: 'tpl_sales', name: 'Sales Review', description: 'Pipeline, bookings and forecast attainment.', sections: 4 },
  {
    id: 'tpl_blank',
    name: 'Blank Document',
    description: 'Start from an empty page with no preset blocks.',
    sections: 0,
  },
]
...
const DELIVERIES: Delivery[] = [
  {
    id: 'dl_1',
    report: 'Revenue Operations Review',
    schedule: 'weekly',
    format: 'pdf',
    recipients: 14,
    nextRun: isoAhead(60 * 20),
    lastStatus: 'sent',
  },
  {
    id: 'dl_2',
    ...
    format: 'excel',
    recipients: 6,
    nextRun: isoAhead(60 * 24 * 9),
    lastStatus: 'sent',
  },
  {
    id: 'dl_3',
    report: 'Platform Reliability Report',
    schedule: 'weekly',
    format: 'pdf',
    recipients: 22,
    nextRun: isoAhead(60 * 46),
    lastStatus: 'failed',
  },
  {
    id: 'dl_4',
    report: 'Executive Weekly',
    schedule: 'weekly',
    format: 'pdf',
    recipients: 5,
  ...
  {
    id: 'dl_5',
    report: 'Marketing Attribution',
    schedule: 'daily',
    format: 'csv',
    recipients: 3,
    nextRun: isoAhead(60 * 3),
    lastStatus: 'sent',
  },
]
