...
export type Permission =
  ...
  | 'pipeline:read' | 'pipeline:write' | 'pipeline:run' | 'pipeline:publish' | 'pipeline:delete'
  | 'dataset:read' | 'dataset:write' | 'dataset:certify'
  | 'semantic:read' | 'semantic:write' | 'semantic:publish'
  | 'dashboard:read' | 'dashboard:write' | 'dashboard:publish' | 'dashboard:share'
  | 'report:read' | 'report:write' | 'report:approve' | 'report:publish'
  | 'insight:read' | 'insight:write'
  | 'ai:use' | 'ai:configure'
  | 'automation:read' | 'automation:write' | 'automation:approve'
  | 'notification:read'
  | 'audit:read'
  | 'usage:read'
  ...
  | 'admin:platform' | 'admin:org' | 'admin:workspace'
  | 'governance:read' | 'governance:write'
  | 'featureflag:read' | 'featureflag:write'
